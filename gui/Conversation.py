...
class Conversation(object):
    ...
    def _load_style(self):
        ...
        self.cstyle = protocol.Style(font, color, font_bold, font_italic,
    ...
    def _update_single_information(self, account):
        ...
        if contact:
            message = e3common.MarkupParser.escape(contact.message)
            nick = e3common.MarkupParser.escape(contact.display_name)
        else:
            message = ''
            nick = account
